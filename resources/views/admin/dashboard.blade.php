...
@section('title', 'Admin Dashboard - D-WarungS')
...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="mb-8">
        ...
        <p class="mt-2 text-gray-600">Monitor your platform statistics</p>
    </div>
    ...
    <!-- Quick Actions -->
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        <a href="{{ route('admin.vendors.index') }}" class="bg-white rounded-xl shadow-sm p-6 hover:shadow-md transition-shadow">
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-500">Approve or reject vendors</p>
                </div>
            </div>
        </a>

        <a href="{{ route('admin.orders.index') }}" class="bg-white rounded-xl shadow-sm p-6 hover:shadow-md transition-shadow">
            <div class="flex items-center gap-4">
                <div class="bg-purple-100 p-3 rounded-lg">
        ...
        <a href="{{ route('home') }}" target="_blank" class="bg-white rounded-xl shadow-sm p-6 hover:shadow-md transition-shadow">
            <div class="flex items-center gap-4">
                <div class="bg-green-100 p-3 rounded-lg">
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-500">Go to homepage</p>
                </div>
            </div>
        </a>
    </div>
