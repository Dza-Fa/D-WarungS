...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="mb-8">
        ...
        <p class="mt-2 text-gray-600">Selesaikan pesanan Anda</p>
    </div>
    ...
    @if(empty($cart))
        <div class="text-center py-16 bg-white rounded-xl shadow-sm">
            ...
            <p class="text-gray-500 mb-6">Tambahkan beberapa barang ke keranjang sebelum checkout.</p>
                        ...
                        <div class="space-y-3">
                            <label class="flex items-center p-4 border border-gray-200 rounded-lg cursor-pointer hover:bg-gray-50 transition-colors">
                                ...
                                <div class="ml-3">
                                    ...
                                    <span class="block text-sm text-gray-500">Bayar ketika Anda mengambil pesanan</span>
                                </div>
                            </label>
                            ...
                            <label class="flex items-center p-4 border border-gray-200 rounded-lg cursor-pointer hover:bg-gray-50 transition-colors">
                                ...
                                <div class="ml-3">
                                    ...
                                    <span class="block text-sm text-gray-500">Transfer ke rekening bank kami</span>
                                </div>
                            </label>
                        </div>
                    </div>
                            ...
                            @foreach($cart as $id => $item)
                                <div class="flex items-center gap-3">
                                    ...
                                    <div class="flex-1 min-w-0">
                                        ...
                                        <p class="text-xs text-gray-500">Jml: {{ $item['quantity'] }}</p>
                                    </div>
