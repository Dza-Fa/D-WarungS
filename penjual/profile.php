...
<div class="page-header">
    <h1 class="page-title">👤 Profile Penjual</h1>
</div>
...
<div class="card">
    ...
    <div class="card-body">
        <div class="form-row">
            <div>
                <strong style="color: #666;">Nama Warung:</strong><br>
                <?php echo esc($warung['nama_warung']); ?>
            </div>
            
            <div>
                <strong style="color: #666;">Alamat:</strong><br>
                <?php echo esc($warung['alamat'] ?? '-'); ?>
            </div>
            
            <div>
                <strong style="color: #666;">Telepon:</strong><br>
                <?php echo esc($warung['nomor_telepon'] ?? '-'); ?>
            </div>
        </div>
        
        <div style="margin-top: 1rem; padding-top: 1rem; border-top: 1px solid #ddd;">
            <strong style="color: #666;">Deskripsi:</strong><br>
            <?php echo esc($warung['deskripsi'] ?? '-'); ?>
        </div>
